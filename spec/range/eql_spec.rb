...
RSpec.describe "Range#eql?" do
  it "returns true if and only if other is a Range, begin and end are equal with #eql? and exclude_end is the same" do
  ...
  it "returns false if begin values aren't equal with #eql?" do
    a = Range.new(RangeSpecs::WithEql.new(0), RangeSpecs::WithEql.new(6), true)
  ...
  it "returns false if end values aren't equal with #eql?" do
    a = Range.new(RangeSpecs::WithEql.new(0), RangeSpecs::WithEql.new(6), true)
