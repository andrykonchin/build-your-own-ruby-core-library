...
RSpec.describe "Enumerable#drop_while" do
  it "calls the block with successive elements as long as the block returns a truthy value;\
    returns an array of all elements after that point" do
    ...
    describe "when no block is given" do
      describe "returned Enumerator" do
        it "size returns nil" do
          ...
          expect(enum.drop_while.size).to eq(nil)
        end
      end
    end
  end
